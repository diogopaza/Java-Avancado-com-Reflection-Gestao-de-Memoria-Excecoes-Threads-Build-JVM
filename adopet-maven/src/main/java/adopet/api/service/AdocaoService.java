...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoDeAdocaoDTO dto){
        ...
        emailService.enviarEmail(tutor.getEmail(),
                "Solicitação de adoção de PET",
                """
                        Olá %s você solicitou a adoção de um %s, chamado de %s.
                        Estamos verificando o cadastro para aprovar a adoção.
                        """.formatted(tutor.getNome(), pet.getTipo(), pet.getNome()));
